<template>
    <div class="settings-section">
        ...
        <div class="settings-section-settings">
			...
			<checkbox-toggle :value.sync="showSlowChatCooldownTimer" @changed="saveSettings()" label="Show Slow Chat Cooldown Timer" tooltip="Display a timer showing your current slow chat cooldown status (shows up once cooldown starts and only if cooldown is 2 secs or longer)"></checkbox-toggle>  
            ...
            <div v-show="showImagesInline" class="option-wrapper suboption">
                ...
                <div style="padding-bottom: 5px;" class="option-title">Trusted Users<option-tooltip name="permUsers" title="Images from these users will ALWAYS show, even if they aren't in a permitted role above."></option-tooltip></div>
